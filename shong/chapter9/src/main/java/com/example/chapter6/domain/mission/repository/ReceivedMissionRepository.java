...
public interface ReceivedMissionRepository extends JpaRepository<ReceivedMission, Long> {
    ...
    Optional<ReceivedMission> findByMemberIdAndMissionId(Long memberId, Long missionId);
    ...
    */
    ...
    // 내가 진행중(또는 완료)인 미션 목록 조회 (페이징)
    // ReceivedMission 엔티티를 반환하도록 변경
    Page<ReceivedMission> findAllByMemberAndStatus(Member member, String status, Pageable pageable);
