...
// [중요] QueryDSL이 빌드(compileQuerydsl)될 때 자동으로 생성되는 Q-Type 클래스입니다.
// 이 Q-Type을 'static import'하여 코드를 간결하게 사용합니다.
// (SQL의 테이블 별칭(alias) 'r', 'm', 's'와 같은 역할을 합니다.)
 ...
 * [규칙] Spring Data JPA가 인식할 수 있도록 클래스 이름은 반드시
 * (기존 리포지토리 이름 + Impl) 이어야 합니다. (e.g., ReviewRepository + Impl)
 */
...
public class ReviewRepositoryImpl implements ReviewRepositoryCustom {
    ...
    /**
     * [동적 쿼리 1] 가게 이름 필터링 조건을 생성하는 헬퍼 메서드
     *
     * @param storeName 컨트롤러에서 받은 가게 이름 파라미터
    ...
    /**
     * [동적 쿼리 2] 별점 필터링 조건을 생성하는 헬퍼 메서드
     *
     * @param rating 컨트롤러에서 받은 별점 파라미터 (e.g., 5, 4, 3)
     * @return BooleanExpression (QueryDSL의 WHERE 절 조건) 또는 null
     */
